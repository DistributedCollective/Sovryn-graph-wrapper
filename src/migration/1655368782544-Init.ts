...
export class Init1655368782544 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "liquidity_pool_summary" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "poolId" character varying NOT NULL, "baseSymbol" character varying NOT NULL, "baseId" character varying NOT NULL, "quoteSymbol" character varying NOT NULL, "quoteId" character varying NOT NULL, "baseVolume24h" numeric(40,18) NOT NULL, "quoteVolume24h" numeric(40,18) NOT NULL, "lastPrice" numeric(40,18) NOT NULL, "lastPriceUsd" numeric(40,8) NOT NULL, "priceChangePercent24h" numeric(10,2) NOT NULL DEFAULT '0', "priceChangePercentWeek" numeric(10,2) NOT NULL DEFAULT '0', "priceChangePercent24hUsd" numeric(10,2) NOT NULL DEFAULT '0', "priceChangePercentWeekUsd" numeric(10,2) NOT NULL DEFAULT '0', "highUsd" numeric(40,8) NOT NULL, "lowUsd" numeric(40,8) NOT NULL, "highBtc" numeric(40,18) NOT NULL, "lowBtc" numeric(40,18) NOT NULL, "baseAssetLiquidity" numeric(40,18), "quoteAssetLiquidity" numeric(40,18), CONSTRAINT "PK_2095e60a76e58a6ace554745790" PRIMARY KEY ("poolId"))`);
    ...
    await queryRunner.query(`CREATE TYPE "public"."tvl_tvlgroup_enum" AS ENUM('tvlAmm', 'tvlLending', 'tvlProtocol', 'tvlSubprotocols', 'tvlStaking', 'tvlZero', 'tvlMynt')`);
